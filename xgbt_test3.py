...
dtrain3 = xgb.DMatrix(traindata[1:, 6:], traindata[1:, 3])
dtest3 = xgb.DMatrix(testdata[1:, 6:], testdata[1:, 3])
...
watchlist  = [(dtest3,'eval'), (dtrain3,'train')]
num_round = 8000
bst = xgb.train(param, dtrain3, num_round, evals = watchlist)
# make prediction
# ntree_limit must not be 0
print('2')
preds = bst.predict(dtest3, ntree_limit=num_round)
...
# scio.savemat('result_our3_3.mat', {'preds':preds})
np.savetxt('../data/result_our3.csv',preds,delimiter=',')
